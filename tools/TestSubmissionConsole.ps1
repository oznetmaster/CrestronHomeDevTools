...
try {
    ...
    $env:SUBMISSION_TEST_DOTNET = (Get-Command dotnet -CommandType Application | Select-Object -First 1).Source
    ...
    $env:SUBMISSION_TEST_PWSH = (Get-Command pwsh -CommandType Application | Select-Object -First 1).Source
