...
- [Optional endurance notifications](docs/submission/EnduranceNotifications.md) (APIs require 1.12.0; unattended Windows setup is in development; authorized SMTP destination required)
- [Reusable private inputs](docs/PrivateInputs.md) (in development)
- [Windows resource assessment](docs/WindowsResources.md) (in development)
