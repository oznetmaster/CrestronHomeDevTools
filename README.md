...
**Source additions after 1.5.0:** [image signing](docs/submission/FormSigning.md) and the optional review-to-signing handoff require source commit [`461f57f`](https://github.com/oznetmaster/CrestronHomeDevTools/commit/461f57ff520a66277589887601d364a591250824) or a later reviewed commit. They are not in the 1.5.0 tag. Their synthetic integration checks pass; a real approved signature, final driver candidate and supported delivery remain pending.
