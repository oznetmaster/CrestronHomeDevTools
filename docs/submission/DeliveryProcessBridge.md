...
These tests use synthetic forms and approvals. A real protected worker still needs reviewed settings, account permissions, real signature/approval inputs and supported uploader/mail providers. No uploader, SMTP implementation, real delivery or Crestron acceptance is supplied by this bridge. Ordinary driver/library releases remain independent of this optional submission stage.
