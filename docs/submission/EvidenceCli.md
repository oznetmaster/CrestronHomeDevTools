...
An ordinary GitHub/NuGet release may use the existing hardware-unavailable override. It must leave Crestron submission pending; it cannot fabricate observations or bypass this submission check. The retained bundle, unsigned review, authorized signing and delivery-preparation stages are implemented and tested with synthetic inputs. Upload and email adapters are available in the protected delivery workflow; real candidate review, signature authorization and end-to-end submission remain pending. See the [complete implementation plan](../CrestronSubmission.md).
