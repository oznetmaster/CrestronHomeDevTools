...
After signed-page review, use the [review approval and delivery route](ReviewApproval.md) with attachment kind `SignedSelfTest`. The legacy complete-only delivery route does not accept this packet.
